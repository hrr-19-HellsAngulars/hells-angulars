...
var ProductDetailsService = (function () {
    ...
    ProductDetailsService.prototype.getReviews = function (id) {
    ...
    ProductDetailsService.prototype.charge = function (token, transaction) {
        var requestBody = { token: token, transaction: transaction };
